...
/**
 * Servlet de gestión de pacientes.
 * Ubicado en el paquete {@code controller} para cumplir la especificación del proyecto.
 *
 * <p>La implementación canónica reside en
 * {@link com.rio.chequeo.servlet.PatientServlet}.
 * El archivo web.xml registra la clase {@code com.rio.chequeo.servlet.PatientServlet}.</p>
 *
 * <ul>
 ...
 *   <li>GET  /patients?id=N     — Carga el paciente N con su expediente y abre el índice.</li>
...
public class PatientServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        // Mapear parámetros del formulario al expediente
        ...
        try {
            ...
            LOGGER.log(Level.SEVERE, "Error persistiendo expediente", e);
            if (isAjax) {
    ...
    private void openNewRecord(HttpServletRequest req, HttpServletResponse resp)
        ...
        session.setAttribute(AppConstants.SESSION_PATIENT_KEY, new MedicalRecord());
    ...
    // -------------------------------------------------------------------------
    // Mapeo campo → setter (misma tabla que SheetServlet)
    // -------------------------------------------------------------------------

    /**
     * Mapea un par (nombre de campo, valor de formulario) al MedicalRecord.
     * Incluye TODOS los campos de las 11 hojas de contenido.
     */
